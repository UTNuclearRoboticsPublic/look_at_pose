...
def handle_look_at_pose(req):
  ...
  T = numpy.matrix( [ [ R_inv.item(0,0), R_inv.item(0,1), R_inv.item(0,2), 0 ],
                      [ R_inv.item(1,0), R_inv.item(1,1), R_inv.item(1,2), 0 ],
                      [ R_inv.item(2,0), R_inv.item(2,1), R_inv.item(2,2), 0 ],
		      [ 0, 0, 0, 1]] )
